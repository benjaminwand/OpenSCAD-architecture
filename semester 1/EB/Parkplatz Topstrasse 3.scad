...
color_pillars = "black";
color_arches = "grey";
color_access = "lightblue";
color_elevator = "CornflowerBlue";
color_private = "#E0DD12";
color_public = "MediumSeaGreen";
color_full_public = "CadetBlue";
color_entrance_doors = "lightblue";
    ...
    if (og1)                    // Gemeinschaftsräume nordwest
        color(color_public) translate([0, 0, h_bodenplatte]) {
            if ($rooms){
                ...
                translate ([10100, 38100, 0]) cube([5700, 4800, 3000]); // basten/textil
